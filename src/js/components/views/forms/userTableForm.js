...
export default class UserTableForm extends PureComponent {
    ...
    render() {
        ...
        const groupClassName = 'user-table-form__group ' + ((this.props.user.groupName !== 'Unmanaged') ? '' : 'user-table-form_bold');
        ...
        return (
            <div className = {className}>
                ...
                <div className={groupClassName}>{this.props.user.groupName}</div>
